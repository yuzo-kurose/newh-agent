...
VDS図スロットとの対応：recoveryEngine＝回収エンジン、pricingModel＝料金モデル（単価設計）、costStructure＝コスト構造（4分類の要約）、profitability＝採算成立（4階層の結論）。各構造化フィールドと整合させる。`,
};
