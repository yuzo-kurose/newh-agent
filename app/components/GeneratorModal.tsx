...
- 各タスクの値は、hypothesis/rationale/validation/outputに分ける。
- hypothesisは「現時点では〇〇の可能性がある」という仮説。
- rationaleはその仮説を置く理由。
- validationは次に確認すべき問い・検証方法。
- outputはそのタスクで作るべき成果物。
...
JSON形式:
{"status":"needs_info|ready","summary":"案件理解の要約","questions":[{"id":"q1","question":"追加で聞く質問","reason":"なぜ必要か"}],"hypotheses":{"setup-s1":{"hypothesis":"仮説","rationale":"根拠","validation":"確認ポイント","output":"成果物"}}}`;
