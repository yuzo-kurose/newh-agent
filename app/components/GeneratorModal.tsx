...
JSON形式:
{"status":"needs_info|ready","summary":"案件理解の要約","questions":[{"id":"q1","question":"追加で聞く質問","reason":"なぜ必要か"}],"hypotheses":{"setup-s1":{"currentHypothesis":"現状仮説","missingInfo":"不足情報","discussionPoints":"議論ポイント","conclusion":"結論"}}}`;
